...
# Autor: Rüdiger Wolff
# Version con función (que no está permitida por anuncio del EAC)
...
# funció per a probar existència-del-home de l’usuari
existenciaHome () {
...
# El programa ha de mostrar el login, uid, gid, gname, home i existència-del-home de l’usuari rebut com argument
...
# Opció 'short'
if [ $2 = short ]; then
	echo $LOGIN $U1D $GID $GNAME $H0M3 $(existenciaHome $1)
